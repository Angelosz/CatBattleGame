...
class OfflineEnemyCatRepository(val dao: EnemyCatDao): EnemyCatRepository {
    ...
    override suspend fun clearEnemyCatsTable() = dao.clearEnemyCatsTable()
    ...
    override suspend fun clearEnemyAbilitiesTable() = dao.clearEnemyAbilitiesTable()
    ...
    override suspend fun clearChapterEnemiesTable() = dao.clearChapterEnemiesTable()
