...
@Composable
fun CollectionDetailsDataCard(
    catDetails: OwnedCatDetailsData,
    ...
    Card(
        ...
        Column(
            ...
            Column(
                ...
                ExperienceBar(
                    level = catDetails.level,
                    experience = catDetails.experience,
                    showText = true
                )
                Text(
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column() {
                            Text(
                                text = "Health: ${catDetails.cat.baseHealth}",
                                modifier = Modifier.padding(4.dp),
                            )
                            Text(
                                text = "Defense: ${catDetails.cat.baseDefense}",
                                modifier = Modifier.padding(4.dp)
                            )
                            Text(
                        ...
                        Column() {
                            Text(
                                text = "Attack: ${catDetails.cat.baseAttack}",
                                modifier = Modifier.padding(4.dp)
                            )
                            Text(
                ...
                Card(
                    ...
                    if (catDetails.evolutionCat != null) {
                        Text(
                            text = "Evolves at level: ${catDetails.cat.evolutionLevel}",
                            modifier = Modifier.padding(top = 8.dp, start = 8.dp)
                        )
                        Text(
                            text = "Evolution: ${catDetails.evolutionCat.second}",
...
@Composable
fun Preview_CollectionDetailsDataCard(){
    CatBattleGameTheme {
        CollectionDetailsDataCard(
            ...
            catDetails = OwnedCatDetailsData(
                ...
                level = 1,
                experience = 200,
                evolutionCat = Pair(2, "Teen Swordman"),
            )
        )
    }
}