                ...
                Card(
                    ...
                    Row(
                        ...
                        Column() {
                            ...
                            Text(
                                text = "Role: ${stringResource(catDetails.cat.role.res)}",
                                modifier = Modifier.padding(4.dp)
                            )

                            Text(
                                text = "Armor type: ${stringResource(catDetails.cat.armorType.res)}",
                                modifier = Modifier.padding(4.dp)
                            )
                        ...
                        Column {
                            ...
                            Text(
                                text = "Rarity: ${stringResource(catDetails.cat.rarity.res)}",
                                modifier = Modifier.padding(4.dp)
                            )
